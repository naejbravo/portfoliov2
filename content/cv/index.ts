/**
 * Contenido del CV — datos reales, no plantilla.
 *
 * A diferencia de la portada (que es plantilla y varía por candidatura), el CV es el
 * documento factual: experiencia, formación y skills reales. Se mantiene aquí una sola vez
 * y de aquí salen los PDF en inglés y alemán.
 *
 * El bloque `Profile` no se escribe aquí: se toma del perfil activo (`profile.intro`), que es
 * también el que titula el CV (`profile.positioning`). Así el CV no puede contradecir a la web.
 */
